    ...
    <div className="rounded-xl bg-white/[0.05] dark:bg-white/[0.07] border border-white/[0.1] dark:border-white/[0.12]">
      ...
      <div className="flex items-center gap-3 px-5 pb-4 pt-2 flex-wrap">
        <button
          ...
          className="inline-flex items-center gap-2 px-4 py-2.5 text-md font-semibold rounded-lg bg-[var(--accent)] text-white hover:opacity-90 transition-opacity shadow-sm"
        >
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-4 py-2.5 text-md font-medium rounded-lg bg-white/[0.08] dark:bg-white/[0.1] text-[var(--foreground)] hover:bg-white/[0.15] dark:hover:bg-white/[0.18] transition-colors border border-white/[0.06] dark:border-white/[0.1]"
        >
      ...
      {showCite && (
        <div ref={citeRef} className="border-t border-black/[0.06] dark:border-white/[0.08] px-4 py-4">
          ...
          <div className="relative">
            <pre className="text-sm leading-relaxed text-[var(--foreground)] bg-black/[0.03] dark:bg-white/[0.03] rounded p-3 overflow-x-auto whitespace-pre-wrap font-mono">
              {citations[citeFormat]}
            </pre>
            <button
              onClick={() => copyToClipboard(citations[citeFormat], "cite")}
              className="absolute top-2 right-2 px-2 py-1 text-xs font-medium rounded bg-[var(--accent)] text-white hover:opacity-90 transition-opacity"
            >
