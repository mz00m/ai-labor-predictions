    ...
    <div className="rounded-xl bg-gradient-to-r from-transparent via-black/[0.02] to-transparent dark:via-white/[0.03]">
      ...
      <div className="flex items-center gap-2 px-4 py-2.5 flex-wrap">
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 px-3 py-1.5 text-[13px] font-medium rounded-md bg-black/[0.04] dark:bg-white/[0.06] text-[var(--foreground)] hover:bg-black/[0.08] dark:hover:bg-white/[0.1] transition-colors"
        >
        ...
        <button
          ...
          className={`inline-flex items-center gap-1.5 px-3 py-1.5 text-[13px] font-medium rounded-md transition-colors ${
            showCite
              ...
              : "bg-black/[0.04] dark:bg-white/[0.06] text-[var(--foreground)] hover:bg-black/[0.08] dark:hover:bg-white/[0.1]"
          }`}
        >
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
