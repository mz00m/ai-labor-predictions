...
function Tooltip({
  ...
  return (
    <div className="relative inline-flex" ref={ref}>
      ...
      {open && (
        <div className="absolute z-50 bottom-full left-0 mb-1.5 w-[240px] p-2.5 rounded-lg bg-[var(--foreground)] text-[var(--background)] text-xs leading-relaxed shadow-xl">
          <p className="opacity-90">{tip}</p>
          {link && (
            <a
              href={link}
              className="inline-block mt-1.5 text-2xs font-medium opacity-70 hover:opacity-100 underline"
            >
              Learn more
            </a>
          )}
    ...
    >
      ...
      <div className="mt-3 flex items-center justify-between">
        ...
        <a
          ...
          className="text-2xs text-[var(--accent-text)] hover:underline whitespace-nowrap ml-2"
        >
          Full methodology
        </a>
      </div>
