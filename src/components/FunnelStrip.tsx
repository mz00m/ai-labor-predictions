...
const stripData = [
  ...
  { study: "Median (8 studies)", value: 21, range: [13, 56] as [number, number], metric: "Employee productivity", sourceUrl: "/research", quote: "Median time saved per task across 8 controlled studies (RCTs and field experiments), from 13% (customer support) to 56% (a single coding task). Real-workplace deployments cluster at 13\u201321%; lab tasks run higher." },
  ...
  { study: "Yale Budget Lab '26", value: 0, range: null, metric: "Measured job loss", sourceUrl: "https://budgetlab.yale.edu/research/evaluating-impact-ai-labor-market-januaryfebruary-cps-update", quote: "Currently, measures of exposure, automation, and augmentation show no sign of being related to changes in employment or unemployment. The January and February 2026 CPS releases do not indicate a meaningful shift from December in most categories." },
                    ...
                    >
                      ...
                      <div
                        ...
                        style={{
                          ...
                          transition: `width 1.8s cubic-bezier(0.16, 1, 0.3, 1) ${barDelay}s, background-color 0.1s ease`,
                        }}
                      />
                      ...
                      <div
                        ...
                        style={{
                          ...
                          transition: `left 1.8s cubic-bezier(0.16, 1, 0.3, 1) ${barDelay}s`,
                        }}
                      >
                        <span
                          ...
                          style={{
                            opacity: visible ? 1 : 0,
                            transition: `opacity 0.3s ease ${barDelay + 0.9}s, color 0.1s ease`,
                          }}
                        >
                          {bar.value}%
                          {isHovered && bar.range && (
