...
const stripData = [
  ...
  { study: "Median (9 studies)", value: 21, range: [13, 56] as [number, number], metric: "Employee productivity", sourceUrl: "/research", quote: "Median time saved per task across 9 controlled studies (RCTs and field experiments), from 13% (customer support) to 56% (a single coding task). Real-workplace deployments cluster at 13\u201321%; lab tasks run higher." },
