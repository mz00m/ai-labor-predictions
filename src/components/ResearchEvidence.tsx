...
const MICRO_STUDIES: MicroStudy[] = [
  ...
  {
    id: "metr-becker-2025",
    authors: "Becker, Rush, Barnes & Rein",
    year: 2025,
    title: "METR Open-Source Devs",
    domain: "Software dev",
    effectPct: -19,
    effectLabel: "-19%",
    finding: "AI made experienced open-source developers 19% slower. Developers expected AI to speed them up by 24% and even after the study believed it helped by 20%.",
    citation: "arXiv:2507.09089",
    url: "https://arxiv.org/abs/2507.09089",
    note: "Major perception-reality gap",
  },
];
