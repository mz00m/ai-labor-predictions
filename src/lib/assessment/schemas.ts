...
export const AssessmentIntakeSchema = z.object({
  ...
  keyRoles: z.array(z.string().max(200)).max(30).default([]),
  ...
  biggestChallenges: z.array(z.string().max(1000)).max(10).default([]),
  goals: z.array(z.string().max(1000)).max(10).default([]),
