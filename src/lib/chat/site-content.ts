...
2. ~1% Projected net job loss by 2030: Median of 4 independent forecasts of net US job loss (Goldman Sachs, Bloom et al. executive survey, Metaculus, Acemoglu). The Anthropic Institute economic scenarios are shown as context only; their authors say they are not predictions, range 0.6-3%. Gross displacement estimates (workers displaced before most are re-employed) are higher, about 6-9% (Forrester, Tufts, Goldman Sachs).
