...
function Expandable({ title, children }: { title: string; children: React.ReactNode }) {
  ...
  return (
    <div className="border border-gray-100 rounded-lg overflow-hidden">
      ...
      {open && <div className="px-5 pb-4 text-[13px] text-gray-500 leading-relaxed border-t border-gray-50">{children}</div>}
    </div>
  );
}
...
function Stat({ value, label }: { value: string; label: string }) {
  return (
    <div className="text-center">
      <div className="text-[28px] font-black text-[#5C61F6]">{value}</div>
...
function SectionNum({ n }: { n: number }) {
  return (
    <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-[#5C61F6]/10 text-[#5C61F6] text-[11px] font-bold mr-3 flex-shrink-0">
      {n}
    </span>
  );
}
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 sm:px-10 py-16">
      ...
      <div className="mb-12">
        ...
        <p className="mt-4 text-[16px] text-gray-500 leading-relaxed max-w-2xl">
      ...
      <section className="mb-14">
        <h2 className="flex items-center text-[18px] font-bold text-gray-900 mb-4">
          <SectionNum n={1} />
          Research Foundation
        </h2>
        ...
        <div className="space-y-3 mb-4">
          {[
            ...
            <div key={s.step} className="bg-gray-50 border border-gray-100 rounded-lg p-4">
              <div className="text-[13px] font-semibold text-gray-900 mb-1">{s.step}</div>
              <div className="text-[13px] text-gray-500">{s.desc}</div>
            </div>
          ))}
        </div>
          ...
          {[
            ...
            <div key={s.title} className="flex gap-3 py-2 border-b border-gray-50 last:border-0">
              ...
              <div>
                ...
                <span className="text-[13px] text-gray-500"> &mdash; {s.desc}</span>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="space-y-2 mb-4">
          {[
            ...
            <div key={d.dim} className="bg-gray-50 border border-gray-100 rounded-lg p-4">
              <div className="text-[13px] font-semibold text-gray-900 mb-1">{d.dim}</div>
              <div className="text-[13px] text-gray-500">{d.desc}</div>
            </div>
          ))}
        </div>
          ...
          {[
            ...
            <div key={item.label} className="flex gap-3 py-2 border-b border-gray-50 last:border-0">
              ...
              <div>
                ...
                <span className="text-[13px] text-gray-500"> &mdash; {item.detail}</span>
              </div>
            </div>
          ))}
        </div>
