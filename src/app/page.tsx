    ...
    <div className="space-y-0">
      ...
      <div className="mt-10">
        <SectionBar
          ...
          description="AI doesn't replace whole jobs — it automates specific tasks. Explore which parts of 70+ occupations are exposed and which remain human-dependent."
          href="/task-visualizer"
          tag="Task visualizer"
          accentColor="#3ECFAE"
          watermark={<TaskVisualizerWatermark color="#3ECFAE" />}
          stat={{ value: "70+", label: "occupations" }}
          featured
        />
