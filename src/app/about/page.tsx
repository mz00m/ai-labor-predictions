...
export default function AboutPage() {
  return (
    <div className="flex flex-col lg:flex-row lg:gap-12">
      ...
      {/* Right column — Recent Sources (sticky scrolling sidebar) */}
      <div className="mt-14 lg:mt-0 lg:w-1/2">
        <div className="lg:sticky lg:top-16 lg:max-h-[calc(100vh-5rem)] lg:overflow-y-auto lg:pr-2 scrollbar-thin">
          <RecentSources />
        </div>
      </div>
    </div>
