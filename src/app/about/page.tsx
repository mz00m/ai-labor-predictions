      ...
      <section className="max-w-3xl">
        <div className="border border-black/[0.06] rounded-lg px-5 py-5 bg-white">
          ...
          <p className="text-[14px] text-[var(--muted)] leading-relaxed">
            ...
            is building this as a personal vibe-coding project, as a way to learn and hopefully create something helpful for others. While not affiliated with his day job, he&rsquo;s the Chief Program &amp; Partnership Officer at the GitLab Foundation,
