  ...
  return (
    <div className="space-y-10">
      ...
      <div className="max-w-3xl">
        <h1 className="text-[36px] sm:text-[48px] font-black tracking-tight text-[var(--foreground)] leading-[1.05] mb-4">
          Compare Predictions
        </h1>
      ...
      <div className="space-y-4">
        {Object.entries(grouped).map(([category, predictions]) => (
          <div key={category}>
            <h3 className="text-[12px] font-bold uppercase tracking-widest text-[var(--muted)] mb-2">
                ...
                <div className="p-5">
                  ...
                  <div className="flex items-start justify-between mb-3">
                    <div>
                      ...
                      <h3 className="text-[16px] font-bold text-[var(--foreground)] leading-tight mt-1">
                        <Link
                  ...
                  <div className="flex items-baseline gap-2 mb-4">
                    ...
                    {agg.min !== agg.max && (
                      <span className="text-[13px] text-[var(--muted)]" style={{ opacity: 0.7 }}>
                        {agg.min}–{agg.max}{unitSymbol}
                      </span>
                    )}
                    {agg.trend !== "flat" && (
                      <span className={`text-[18px] ${trendColorClass}`} style={{ opacity: 0.5 }}>
                        {agg.trend === "up" ? "▲" : "▼"}
                      </span>
                    )}
                  </div>
