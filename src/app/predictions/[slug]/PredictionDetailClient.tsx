...
const CONTEXT_MAP: Record<string, (v: number) => string> = {
  ...
  "customer-service-automation": (v) =>
    `${v}% of all customer service interactions (phone calls, chat messages, emails) will likely be handled by AI without a human agent ever getting involved. This doesn't mean ${v}% of CS jobs disappear, since the remaining interactions may need more skilled human agents, but headcount reductions are widely expected.`,
