        ...
        {prediction.slug === "genai-work-adoption" ? (
          ...
          <>
            <PredictionChart
              ...
              yAxisMax={prediction.slug === "workforce-ai-exposure" ? 100 : prediction.slug === "earnings-call-ai-mentions" ? 100 : prediction.slug === "customer-service-automation" ? 75 : prediction.slug === "ai-adoption-rate" ? 75 : prediction.slug === "entry-level-wage-impact" || prediction.slug === "freelancer-rate-impact" ? 5 : prediction.slug === "tech-sector-displacement" ? 35 : prediction.slug === "median-wage-impact" ? 10 : prediction.slug === "white-collar-professional-displacement" ? 25 : undefined}
              yAxisMin={prediction.slug === "entry-level-wage-impact" || prediction.slug === "freelancer-rate-impact" ? -50 : prediction.slug === "tech-sector-displacement" ? -20 : prediction.slug === "median-wage-impact" ? -10 : prediction.slug === "white-collar-professional-displacement" ? -25 : undefined}
