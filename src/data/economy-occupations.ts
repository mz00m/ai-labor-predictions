...
export const SOC_TO_JOB_IDS: Record<string, string[]> = {
  ...
  "healthcare-practitioners": ["physician", "pharmacist", "registered-nurse", "dental-hygienist", "radiologist", "dentist"],
  "healthcare-support": ["registered-nurse"],
  "protective-service": ["police-officer"],
  "food-serving": ["restaurant-manager", "fast-food-worker", "waiter-waitress"],
  "building-grounds": [],
  ...
  "farming-fishing": [],
  "construction": ["electrician", "plumber", "construction-manager", "construction-laborer"],
