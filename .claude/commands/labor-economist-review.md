...
- **Task dimensionality and "What will be scarce?" (Ghosts of Electricity, 2026).** In "How Will AI-driven Automation Actually Affect Jobs?" Imas formalizes a task-dimensionality argument: low-dimensional jobs (few tasks) face higher displacement risk per automated task because the firm's incentive to automate rises as residual human tasks shrink. In "What will be scarce?" (April 2026), he argues AI-driven commodity abundance redirects spending toward a "relational sector" where human provenance is part of the value — extending the demand-side/micro-macro bridge from "will demand collapse?" to *where* demand migrates. Gives the persona a crisp theoretical lever (task dimensionality × price elasticity) distinct from the productivity-study survey.
